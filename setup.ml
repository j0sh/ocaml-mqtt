...
(* OASIS_START *)
(* DO NOT EDIT (digest: e9fe36232719dfebd8bce66d225da2d0) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("test/mqtt_test", []))];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("lwt",
                               Some (OASISVersion.VGreaterEqual "2.7.0"));
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "mqtt"; FindlibPackage ("lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "example.ml"});
               Executable
                 ({
                     cs_name = "mqtt_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "LA\tx2\016\219\189o\245#T\187t.k";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
